...
class GlobalVariableType(BaseModel):
    """
    GlobalVariableType
    """ # noqa: E501
    type: Optional[StrictStr] = 'global_variable_type'
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['global_variable_type']):
            raise ValueError("must be one of enum values ('global_variable_type')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GlobalVariableType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GlobalVariableType from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "type": obj.get("type") if obj.get("type") is not None else 'global_variable_type',
